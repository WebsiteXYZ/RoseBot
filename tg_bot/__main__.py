            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Aᴅᴅ Mᴇ Tᴏ Gʀᴏᴜᴘ", url="t.me/{}?startgroup=true".format(bot.username))],
                     [InlineKeyboardButton(text="🔔 Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ", url="https://t.me/Virab_bot_updates"),InlineKeyboardButton(text="🛠 Hᴇʟᴘ", url="https://t.me/{}?start=help".format(bot.username)) ]]))
